...
pub fn get_devices(scope: &Scope) -> Result<Vec<AudioObject>, Error> {
    let system_device = AudioSystemObject::new();
    system_device.get_devices(scope)
}

pub fn get_all_devices() -> Result<Vec<AudioObject>, Error> {
    let system_device = AudioSystemObject::new();
    system_device.get_all_devices()
}
...
pub fn set_default_device(
    ...
    let system_device = AudioSystemObject::new();
    system_device.set_default_device(device, scope)
}
...
impl AudioObject {
    ...
    fn get_device_source(
        ...
        let source: u32 = self.get_property_data(address)?;
        Ok(source)
    }
    ...
    fn get_property_data<T: Default>(
        ...
        let data: T = audio_object::get_property_data(self.0, address)?;
        Ok(data)
    }
    ...
    fn get_property_data_with_ptr<T>(
        ...
        audio_object::get_property_data_with_ptr(self.0, address, data)?;
        Ok(())
    }
    ...
    fn get_property_data_size(
        ...
        let size = audio_object::get_property_data_size(self.0, address)?;
        Ok(size)
    }
}
...
// AudioSystemObject
// ------------------------------------
struct AudioSystemObject(AudioObjectID);
...
impl AudioSystemObject {
    ...
    fn get_all_devices(&self) -> Result<Vec<AudioObject>, Error> {
        let ids: Vec<AudioObject> = self.get_property_array::<AudioObject>(
    ...
    fn get_property_array<T>(
        ...
        let array = audio_object::get_property_array::<T>(self.0, address)?;
        Ok(array)
    }
    ...
    fn set_property_data<T>(
        ...
        audio_object::set_property_data(self.0, address, data)?;
        Ok(())
    }
}
